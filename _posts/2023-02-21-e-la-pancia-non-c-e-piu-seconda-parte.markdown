...
Se vi siete persi la [prima parte sul gonfiore addominale](/2023/02/07/e-la-pancia-non-c-e-piu-prima-parte.html), recuperatela: lì spiego perché l’intestino è grande quanto un campo da basket e perché la pancia gonfia è un segnale da ascoltare.

## Cos’è il microbiota: un organo dimenticato
...
## Eubiosi vs disbiosi: l’equilibrio che protegge
...
In questo stato di eubiosi, equilibrio, sono compresi anche quei batteri potenzialmente patogeni, o cattivi, che finché la nostra flora è varia e abbondante tiene a bada, e non gli permette di moltiplicarsi oltre la norma o di migrare verso qualche distretto del corpo che non è quello abituale. Tra questi ricordiamo i più famosi: _Helicobacter_, famoso per i problemi che può arrecare allo stomaco; _Candida_, un fungo fastidioso alle vie genitali femminili, all’intestino e anche alla mucosa orale; _Stafilococco aureo_.
...
È proprio di queste tre cause — alimentazione, farmaci e stress — che parlo in dettaglio nella [terza parte: cause del gonfiore di pancia](/2023/03/29/e-la-pancia-non-c-e-piu-terza-parte.html).

## Resilienza del microbiota: quando serve il probiotico
...
Un esempio recentissimo di resilienza guidata: per lo _Stafilococco aureo_ voglio citarvi un [articolo recentissimo](https://www.nih.gov/news-events/nih-research-matters/probiotic-blocks-staph-bacteria-colonizing-people) in cui Stafilococco, dalle sue sedi tradizionali, come la superficie della pelle, il naso, l’intestino, migra verso aree come sangue, polmoni, ossa, o sotto l’epidermide, creando gravi infezioni persino fatali. Bene, [questo studio](https://doi.org/10.1016/S2666-5247(22)00322-6) ci porta ad un risultato che ha dell’incredibile, e cioè l’utilizzo di un altro batterio, un **probiotico**, per riaccompagnare lo Stafilococco all’interno del suo perimetro dove alberga senza recare danno, riducendo la sua presenza di quasi il 95%, senza alcun effetto collaterale. Evitando così l’uso di antibiotici che colpirebbero tutti i batteri, anche quelli benefici, che risiedono nel nostro organismo.

Quando il microbiota non è sufficientemente resiliente — dopo antibiotici, stress prolungato o alimentazione squilibrata — può impiegare mesi, fino a due anni, per tornare in eubiosi. È lì che un probiotico mirato, scelto con criterio clinico, aiuta a ripristinare più in fretta equilibrio, immunità e anche umore. Perché sì: **se il microbiota è in equilibrio, manda al cervello sostanze che migliorano l’umore**, tramite l’asse microbiota-intestino-cervello.
...
← [Prima parte: l’intestino grande come un campo da basket](/2023/02/07/e-la-pancia-non-c-e-piu-prima-parte.html) | [Terza parte: stress, farmaci e alimentazione →](/2023/03/29/e-la-pancia-non-c-e-piu-terza-parte.html)
